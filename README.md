...
- Pay-per-use content unlocks
- On-chain proof of access (receipts)

---

## 🧩 Vision

> “Temporary rights. On-chain proof.”

This repo will eventually host the **core Rust program** and **on-chain schema** for XF402, defining:
- `R402Profile` — access tiers, duration, and price
- `Receipt` — proof of payment & validity
- `Verify` instruction — check if a wallet currently holds active access
...
## 📜 License
MIT — open standard, community contributions welcome.